...
public sealed class ParameterListSyntax : SyntaxNode
{
	...
	public SyntaxList<BaseParameterSyntax> Parameters { get; }
	...
	internal ParameterListSyntax(SyntaxTree tree, Token openParen, SyntaxList<BaseParameterSyntax> parameters, Token closeParen)
		: base(tree)
	{
		OpenParen = openParen;
