...
{
	internal SyntaxToken(SyntaxTree tree, SyntaxKind kind, uint position, StringSegment text, ImmutableArray<SyntaxTrivia> leadingTrivia, ImmutableArray<SyntaxTrivia> trailingTrivia) : base(tree)
	{
		Kind = kind;
		Position = position;
		Text = text;
